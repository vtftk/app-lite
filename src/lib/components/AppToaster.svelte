...
<style global>
  ...
  :global(:where([data-sonner-toast]))
    :global(:where([data-button]):focus-visible) {
    box-shadow: 0 0 0 2px rgba(0, 0, 0, 0.4);
  }

  :global(:where([data-sonner-toast]))
    :global(:where([data-button]):first-of-type) {
    margin-left: var(--toast-button-margin-start);
    margin-right: var(--toast-button-margin-end);
  }
  ...
  :global(:where([data-sonner-toast][data-theme="dark"]))
    :global(:where([data-cancel])) {
  ...
  :global(:where([data-sonner-toast]))
    :global(:where([data-close-button]):focus-visible) {
    box-shadow:
      0px 4px 12px rgba(0, 0, 0, 0.1),
      0 0 0 2px rgba(0, 0, 0, 0.2);
  }
  ...
  :global(:where([data-sonner-toast]):hover)
    :global(:where([data-close-button]):hover) {
