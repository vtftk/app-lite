...
export type ItemCollectionId = Uuid;
...
export type ItemCollectionWithItemLinks = ItemCollection & {
  items: ItemCollectionItemLink[];
};
...
export type ItemCollectionWithItems = ItemCollection & {
  items: ItemWithOrder[];
};

export type ItemCollectionItemLink = {
  item_id: ItemId;
  item_collection_id: ItemCollectionId;
  order: number;
};

export type CreateItemCollection = {
  name: string;
};

export type UpdateItemCollection = {
  id: ItemCollectionId;
  update: Partial<{
    name: string;
    order: number;
...
export type SetItemCollectionItems = {
  id: ItemCollectionId;
  items: ItemId[];
};

export type AppendItemCollectionItems = {
  id: ItemCollectionId;
  items: ItemId[];
};
